...
class Graph {
	...
	public void Visit(Vertex AnotherVertex, Vertex CurrentVertex, String[] PathArray)

	{
		PathArray[VertexToIndex(AnotherVertex)] = 
		        PathArray[VertexToIndex(CurrentVertex)] + CurrentVertex.label;
	}
	...
	void ShortestPath(String SourceLabel, String DestinationLabel) {
		...
		System.out.println("Shortest path from Vertex " + SourceLabel + " to Vertex " + DestinationLabel + " is: ");

		if (PathArray[VertexToIndex(LabelToVertex(DestinationLabel))] == null)
			return;

		System.out.println(PathArray[VertexToIndex(LabelToVertex(DestinationLabel))] + DestinationLabel);
