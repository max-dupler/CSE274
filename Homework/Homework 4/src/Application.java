...
class Node {
    ...
    public String getdata(){return String.valueOf(data);}    
...

{
    ...
    private Node addRecursive(Node current, String key, int data) {
        ...
        return current;  /// This line is added only to show the compiler that there is always a return data. 
    }
   ...
   private int doMappingRecursive(Node current, String key) {
	 ...
	 return -1; /// This line is added only to show the compiler that the method always has a return data
	}
   ...
   private  Node deleteRecursive(Node current, String key) {
	    ...
	    return null; /// This line is added only to show the compiler that there is always a return data. 
